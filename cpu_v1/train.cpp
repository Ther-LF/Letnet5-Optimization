...
int main()
{
    ProfilerStart("LeNet5-train-profiler.prof");
    ...
    const char* train_sample_path = "./dataset/train-images.idx3-ubyte";
    const char* train_label_path = "./dataset/train-labels.idx1-ubyte";
    ...
    //const char* test_sample_path = "./dataset/t10k-images.idx3-ubyte";
    //const char* test_label_path = "./dataset/t10k-labels.idx1-ubyte";
